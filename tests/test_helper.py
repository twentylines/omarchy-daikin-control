...
class HelperTests(unittest.TestCase):
    ...
    def test_temperature_units_and_chart_gradient_are_wired(self):
        ...
        self.assertIn('text: "CURRENT WINDOW · LAST " + root.formatHours(root.historyHours)', panel)
    ...
    def test_plugin_version_is_0_3_3_and_settings_title_is_not_repeated(self):
        manifest = json.loads((HELPER.parent / "manifest.json").read_text(encoding="utf-8"))
        self.assertEqual(manifest["version"], "0.3.3")
        panel = (HELPER.parent / "Panel.qml").read_text(encoding="utf-8")
        self.assertIn('readonly property string pluginVersion: "0.3.3"', panel)
